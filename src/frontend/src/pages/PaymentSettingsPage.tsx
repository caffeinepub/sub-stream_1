...
export function PaymentSettingsPage({ onBack }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Tab content + banner scrollable together */}
              ...
              >
                ...
                >
                  ...
                  <p className="text-white/50 text-xs leading-relaxed">
                    Your payment information is encrypted. Card numbers are
                    never stored in plain text. Identity verification is
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-white/40 text-xs leading-relaxed">
                        Payout is encrypted and processed securely. Your
                        identity will be verified before funds are released.
                      </p>
                    </div>
                    <div className="flex gap-3">
                      <button
